...
export const MODULES: TOptionItem[] = [
  ...
  {
    key: EModule.STAFF_MANAGEMENT,
    label: "Staff Management Module",
    value: "13",
  },
  ...
  {
    key: EModule.PROJECT_PERFORMANCE_REPORT,
    label: "Project Performance Report",
    value: "28",
  },
  {
    key: EModule.LEAD_ANALYTICS_REPORT,
    label: "Lead Analytics Report",
    value: "29",
  },
  {
    key: EModule.BUSINESS_ANALYSIS_REPORT,
    label: "Business Analysis Report",
    value: "30",
  },
  {
    key: EModule.PUBLIC_BUSINESS_DASHBOARD,
