 ...
 */
export interface ILeadSourcesListTable {
  source:undefined ;
 ...
 */
export const LeadSourcesListTable: ILeadSourcesListTable[] = [
  {
    id: 1,
    name: "Website ",
    number: "07-25-2022",
 ...
 */
export const leadaction: ITableAction<ILeadSourcesListTable>[] = [
  {
    label: "Edit",
    onClick: (row) => {
