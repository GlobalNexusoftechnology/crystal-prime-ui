...
// AnalyticalCardIcon component renders a hamburger menu icon as an SVG.
export function AnalyticalCardIcon({
  ...
  return (
    ...
    >
      ...
      />
      <path
        d="M5.5 19.5L6.0604 18.5193C6.95061 16.9615 8.60733 16 10.4017 16H13.5984C15.3927 16 17.0494 16.9615 17.9396 18.5193L18.5 19.5"
        stroke={color}
        strokeWidth="1.5"
        strokeLinecap="round"
        strokeLinejoin="round"
