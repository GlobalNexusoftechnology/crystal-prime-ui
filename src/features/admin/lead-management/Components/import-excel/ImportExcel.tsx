...
export function ImportExcel({ setAddLeadModalOpen }: ImportExcelProps) {
  ...
  return (
    <div className=" bg-white overflow-y-auto h-[31rem]">
      <div className="space-y-6 p-4 ">
        ...
        {step === 1 && (
          <>
            ...
            <div className="p-4 rounded-lg">
              ...
              <div className="space-y-2 ml-2 text-sm text-gray-700">
            ...
            <div className="space-y-3">
              ...
              <div className="flex items-start space-x-2">
                ...
                <label htmlFor="ignoreFields" className="text-sm text-gray-700">
                  <span className="font-medium">Ignore these columns</span>
                  <br />
            ...
            <div className="space-y-2">
              ...
              <div className="flex items-center space-x-2 pt-2">
                <input
                  ...
                  className="accent-black"
                />
                <label htmlFor="multiAssign" className="text-sm text-gray-700">
        ...
        {step === 2 && (
          <div className="text-center">
            <p className="text-gray-600">Next step goes here...</p>
