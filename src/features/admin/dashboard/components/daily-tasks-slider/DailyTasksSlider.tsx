...
export function DailyTasksSlider() {
  ...
  return (
    <div className="border rounded-xl 2xl:rounded-[0.75vw] p-4 2xl:p-[1vw] w-[40vw]">
      {/* Header */}
      <div className="flex justify-between items-center mb-4 2xl:mb-[1vw]">
        <span className="text-sm 2xl:text-[0.875vw] font-semibold">Daily Task</span>
  ...
  <div className="relative flex justify-between items-center">
    ...
    {/* Card Stack */}
    <div className="relative flex justify-center items-center w-full max-w-[400px] 2xl:max-w-[30vw] h-[240px] 2xl:h-[16vw]">
