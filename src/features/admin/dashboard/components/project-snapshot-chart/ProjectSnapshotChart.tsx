...
export const ProjectSnapshotChart: React.FC<ProjectSnapshotChartProps> = ({ data, colors }) => {
  ...
  return (
    <div className="bg-white rounded-xl p-4 border 2xl:border-[0.1vw] border-gray-300 flex flex-col items-center min-w-[260px] max-w-[320px]" style={{ boxShadow: '0 2px 8px rgba(0,0,0,0.04)' }}>
