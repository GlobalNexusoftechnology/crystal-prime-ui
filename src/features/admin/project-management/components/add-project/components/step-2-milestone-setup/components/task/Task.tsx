          ...
          <td className="py-2 text-right relative">
            ...
            {menuOpen && menuOpen.taskId === task.id && (
              <div className="absolute right-[80%] bottom-[10%] mt-2 2xl:mt-[0.5vw] bg-white border rounded shadow z-10 min-w-[100px]">
                <button
                  className="block w-full text-left px-4 py-2 hover:bg-gray-100 text-sm 2xl:text-[0.9vw]"
                  onClick={() => onEdit(milestoneId, task)}
                >
                  Edit
                </button>
                <button
                  className="block w-full text-left px-4 py-2 hover:bg-gray-100 text-red-600 text-sm 2xl:text-[0.9vw]"
