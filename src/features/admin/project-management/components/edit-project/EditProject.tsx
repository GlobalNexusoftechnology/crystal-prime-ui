  ...
  useEffect(() => {
    if (projectDetailData) {
      ...
      const formValues: IAddProjectFormValues = {
        ...
        actual_cost: projectDetailData.actual_cost || 0,
        ...
        actual_start_date: projectDetailData.actual_start_date ? new Date(projectDetailData.actual_start_date) : undefined,
        actual_end_date: projectDetailData.actual_end_date ? new Date(projectDetailData.actual_end_date) : undefined,
