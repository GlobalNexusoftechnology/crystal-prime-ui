...
export function TicketInfo({ ticketInfoData }: ITicketInfoProps) {
  ...
  return (
    <div className="border-b p-4 2xl:p-[1vw]">
      <h3 className="text-[1.2rem] 2xl:text-[1.2vw] mb-4 2xl:mb-[1vw]">Ticket Info</h3>
      <div className="flex flex-col gap-8 2xl:gap-[2vw] text-[0.9rem] 2xl:text-[0.875vw]">
        <div className="flex gap-12 2xl:gap-[3vw] items-start">
          <div className="flex flex-col">
            <p className="font-light text-[0.9rem] 2xl:text-[0.875vw]">Ticket Title</p>
        ...
        <div className="flex gap-12 2xl:gap-[3vw] items-center">
          <div className="flex flex-col">
            <p className="font-light text-[0.9rem] 2xl:text-[0.875vw]">Priority</p>
            <span className={`px-3 py-1 rounded-full text-[0.9rem] font-semibold ${getPriorityColor(ticketInfoData.priority)}`}>
              {ticketInfoData.priority}
            </span>
          </div>
          <div className="flex flex-col">
            <p className="font-light text-[0.9rem] 2xl:text-[0.875vw]">Remark</p>
            <p className="text-[1rem] 2xl:text-[1.1vw]">
