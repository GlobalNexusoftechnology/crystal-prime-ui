  ...
  return (
    <div className="border-b 2xl:border-b-[0.1vw]">
      <div className="bg-white rounded-xl p-6 w-full max-w-xl">
        ...
        <div className="flex flex-wrap gap-8 mt-8 text-gray-700 text-lg font-medium">
          <div>
            <div>Avg Task Completion Time</div>
            <div className="underline cursor-pointer font-medium 2xl:text-[1vw]">
              {data.avgCompletionTime}
            </div>
          </div>
          <div>
            <div>Task Reassignment Count</div>
            <div className="underline cursor-pointer font-medium 2xl:text-[1vw]">
              {data.reassignmentCount}
            </div>
          </div>
        </div>
        <div className="mt-8 text-gray-900 text-lg font-medium">
          Top Performer
          <br />
          <span className="font-medium 2xl:text-[1vw]">
