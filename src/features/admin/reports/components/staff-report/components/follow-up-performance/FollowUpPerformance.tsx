export function FollowUpPerformance() {
  return (
    <div className="border-b 2xl:border-[0.1vw] p-6 2xl:p-[1vw]">
      <h3 className="text-[1.2rem] 2xl:text-[1.2vw] mb-4 2xl:mb-[1vw] font-medium">Follow-Up Performance</h3>
      <div className="flex flex-wrap gap-12 2xl:gap-[3vw] text-[0.9rem] 2xl:text-[0.875vw] mb-4 2xl:mb-[1vw]">
        <div className="flex flex-col">
          ...
          <span className="underline font-semibold text-[1rem] 2xl:text-[1.1vw] cursor-pointer">4</span>
        </div>
        <div className="flex flex-col">
          <span className="font-light">Completed Follow-Ups</span>
          <span className="underline font-semibold text-[1rem] 2xl:text-[1.1vw] cursor-pointer">8</span>
        </div>
        <div className="flex flex-col">
      ...
      <div className="flex flex-col">
        ...
        <span className="underline font-semibold text-[1rem] 2xl:text-[1.1vw] cursor-pointer">4.5 Hr</span>
      </div>
    </div>
  );
} 