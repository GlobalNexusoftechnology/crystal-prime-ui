...
export function AnalyticalCard({ data }: AnalyticalCardDataProps) {
  return (
    <div className="w-full bg-customGray border 2xl:border-[0.1vw] border-gray-300 rounded-lg 2xl:rounded-[0.5vw] p-4  2xl:p-[1vw] ">
      <div className="w-full flex items-center justify-start gap-3 2xl:gap-[0.75vw] mb-2 2xl:mb-[0.5vw] border 2xl:border-[0.1vw] border-gray-300 rounded-lg 2xl:rounded-[0.5vw] bg-white p-2 2xl:p-[0.5vw]">
